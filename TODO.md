...
- [ ] **Enable Supabase RLS**: Switch backend to use `SUPABASE_SERVICE_ROLE_KEY` instead of `SUPABASE_ANON_KEY`, then enable Row-Level Security (RLS) on all Supabase tables to secure the database against public API modifications.
